	...
	$("#subscribeForm input").jqBootstrapValidation({
		...
		submitSuccess: function($form, e) {
			...
			$.ajax({
				...
				cache: false,
				success: function() {
					$('#subscribeForm .success').html("Je bent nu ingeschreven voor onze nieuwsbrief!");
					$('#subscribeForm').trigger("reset");
				},
				error: function() {
					$('#subscribeForm .success').html("<span class=\"error\">We kunnen je niet inschrijven op het moment. Probeer het later opnieuw!</span>");
					//$('#subscribeForm').trigger("reset");
				},
			});
		},
